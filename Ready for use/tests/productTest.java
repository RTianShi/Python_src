...
//        assertTrue(originalResult >= transformResult15);
    ...
    @Test
    public void testProductCase1() {
        Double[] originalInput = {1.0, 2.0, 3.0};
        double originalResult = product.product_m(originalInput);
        applyMR_Assert(originalInput, originalResult);

    }

    @Test
    public void testProductCase2() {
    ...
    @Test
    public void testProductCase5() {
        Double[] originalInput = {2.50, 4.78, 6.61};
        double originalResult = product.product_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testProductCase6() {
        Double[] originalInput = {10.1, 11.2, 12.3};
        double originalResult = product.product_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testProductCase7() {
        Double[] originalInput = {1.58, 2.58, 3.58};
        double originalResult = product.product_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testProductCase8() {
