import example.ebeAdd;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class ebeAddTest {
    ...
    private void applyMR_Assert(Double[] originalInput1_1, Double[] originalInput1_2, Double[] originalResult) {
        ...
        Double[] transformResult1 = ebeAdd.ebeAdd_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
...
//        System.out.println("转换后的数组应该是：" + Arrays.toString(transformInput2_2));
        Double[] transformResult2 = ebeAdd.ebeAdd_m(transformInput2_1, transformInput2_2);
        ...
        Double[] transformResult3_1 = ebeAdd.ebeAdd_m(transformInput3_1, transformInput3_2);
        ...
        Double[] transformResult3_2 = ebeAdd.ebeAdd_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        Double[] transformResult4 = ebeAdd.ebeAdd_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        Double[] transformResult5 = ebeAdd.ebeAdd_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        Double[] transformResult6 = ebeAdd.ebeAdd_m(transformInput6_1, transformInput6_2);
        ...
        Double[] transformResult7_1 = ebeAdd.ebeAdd_m(transformInput7_1, transformInput7_2);
        ...
        Double[] transformResult7_2 = ebeAdd.ebeAdd_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        Double[] transformResult8 = ebeAdd.ebeAdd_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        Double[] transformResult9 = ebeAdd.ebeAdd_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        Double[] transformResult10 = ebeAdd.ebeAdd_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        Double[] transformResult11 = ebeAdd.ebeAdd_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        Double[] transformResult12 = ebeAdd.ebeAdd_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        Double[] transformResult13 = ebeAdd.ebeAdd_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
        ...
        Double[] transformResult14 = ebeAdd.ebeAdd_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        Double[] transformResult15 = ebeAdd.ebeAdd_m(transformInput15_1, transformInput15_2);
        ...
        Double[] transformResult16 = ebeAdd.ebeAdd_m(transformInput16_1, transformInput16_2);
        ...
        Double[] transformResult19 = ebeAdd.ebeAdd_m(transformInput19_1, transformInput19_2);
        ...
        Double[] transformResult20 = ebeAdd.ebeAdd_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        Double[] transformResult22 = ebeAdd.ebeAdd_m(transformInput22_1, transformInput22_2);
        //----------------------------------------------------------
...
//        assertArraySumIncreasedOrEqual(originalResult, transformResult19);
    ...
    public void testCase1() {
        ...
        Double[] originalResult = ebeAdd.ebeAdd_m(originalInput1_1, originalInput1_2);
