import example.pooledMean;
import org.junit.Test;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

public class pooledMeanTest {
    ...
    private void applyMR_Assert(Double[] originalInput1_1, Double[] originalInput1_2, double originalResult) {
        ...
        double transformResult1 = pooledMean.pooledMean_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double transformResult2 = pooledMean.pooledMean_m(transformInput2_1, transformInput2_2);
        ...
        double transformResult3_1 = pooledMean.pooledMean_m(transformInput3_1, transformInput3_2);
        ...
        double transformResult3_2 = pooledMean.pooledMean_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = pooledMean.pooledMean_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        double transformResult5 = pooledMean.pooledMean_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double transformResult6 = pooledMean.pooledMean_m(transformInput6_1, transformInput6_2);
        ...
        double transformResult7_1 = pooledMean.pooledMean_m(transformInput7_1, transformInput7_2);
        ...
        double transformResult7_2 = pooledMean.pooledMean_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double transformResult8 = pooledMean.pooledMean_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double transformResult9 = pooledMean.pooledMean_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double transformResult10 = pooledMean.pooledMean_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double transformResult11 = pooledMean.pooledMean_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double transformResult12 = pooledMean.pooledMean_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double transformResult13 = pooledMean.pooledMean_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
        ...
        double transformResult14 = pooledMean.pooledMean_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double transformResult15 = pooledMean.pooledMean_m(transformInput15_1, transformInput15_2);
        ...
        double transformResult16 = pooledMean.pooledMean_m(transformInput16_1, transformInput16_2);
        ...
        double transformResult19 = pooledMean.pooledMean_m(transformInput19_1, transformInput19_2);
        ...
        double transformResult20 = pooledMean.pooledMean_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        double transformResult22 = pooledMean.pooledMean_m(transformInput22_1, transformInput22_2);
        //----------------------------------------------------------
...
//        assertTrue(originalResult <= transformResult19);
    ...
    @Test
    public void testPooledMean_6() {
        Double[] originalInput1_1 = {6.1, 7.2};
        Double[] originalInput1_2 = {-0.3, 0.4, -0.5, 0.6};
        double originalResult = pooledMean.pooledMean_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledMean_7() {
    ...
    @Test
    public void testPooledMean_9() {
        Double[] originalInput1_1 = {1.111, 2.222, 3.333, 4.444};
        Double[] originalInput1_2 = {5.555, 6.666};
        double originalResult = pooledMean.pooledMean_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledMean_10() {
