...
//        int[] transformResult15 =    reverse.   reverse_m(transformInput15);
        ...
        int[] transformResult20 = reverse.reverse_m(transformInput20_1);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        int[] transformResult22 = reverse.reverse_m(transformInput22);
        //----------------------------------------------------------
...
//        System.out.println("转换后的输出应该是：" + Arrays.toString(transformResult20));
    ...
    public void testReverseCase1() {
        ...
        int[] originalResult = reverse.reverse_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testReverseCase2() {
        Integer[] originalInput = {-1, 0, 1};
        int[] originalResult = reverse.reverse_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testReverseCase5() {
        Integer[] originalInput = {100, -250, 300};
        int[] originalResult = reverse.reverse_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    @Test
    public void testReverseCase7() {
        Integer[] originalInput = {5, 10, 15, 20, 25, 30};
        int[] originalResult = reverse.reverse_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testReverseCase8() {
        Integer[] originalInput = {18, 26, 37, 48, 59};
        int[] originalResult = reverse.reverse_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testReverseCase9() {
        Integer[] originalInput = {100, 200, 300};
        int[] originalResult = reverse.reverse_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testReverseCase10() {
        Integer[] originalInput = {4, 3, 2, 1};
        int[] originalResult = reverse.reverse_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
}