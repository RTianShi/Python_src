...
public class cosineDistanceTest {
    ...
    private void applyMR_Assert(Double[] originalInput1_1, Double[] originalInput1_2, double originalResult) {
        ...
        double transformResult1 = cosineDistance.cosineDistance_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double transformResult2 = cosineDistance.cosineDistance_m(transformInput2_1, transformInput2_2);
        ...
        double transformResult3_1 = cosineDistance.cosineDistance_m(transformInput3_1, transformInput3_2);
        ...
        double transformResult3_2 = cosineDistance.cosineDistance_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = cosineDistance.cosineDistance_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        double transformResult5 = cosineDistance.cosineDistance_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double transformResult6 = cosineDistance.cosineDistance_m(transformInput6_1, transformInput6_2);
        ...
        double transformResult7_1 = cosineDistance.cosineDistance_m(transformInput7_1, transformInput7_2);
        ...
        double transformResult7_2 = cosineDistance.cosineDistance_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double transformResult8 = cosineDistance.cosineDistance_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double transformResult9 = cosineDistance.cosineDistance_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double transformResult10 = cosineDistance.cosineDistance_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double transformResult11 = cosineDistance.cosineDistance_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double transformResult12 = cosineDistance.cosineDistance_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double transformResult13 = cosineDistance.cosineDistance_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
        ...
        double transformResult14 = cosineDistance.cosineDistance_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double transformResult15 = cosineDistance.cosineDistance_m(transformInput15_1, transformInput15_2);
        ...
        double transformResult16 = cosineDistance.cosineDistance_m(transformInput16_1, transformInput16_2);
        ...
        double transformResult19 = cosineDistance.cosineDistance_m(transformInput19_1, transformInput19_2);
        ...
        double transformResult20 = cosineDistance.cosineDistance_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        double transformResult22 = cosineDistance.cosineDistance_m(transformInput22_1, transformInput22_2);
        //----------------------------------------------------------
...
//        assertTrue(originalResult >= transformResult20);
    ...
    public void testCase1() {
        Double[] originalInput1_1 = {1.25, -0.75, 3.55};
        Double[] originalInput1_2 = {0.55, 1.20, -2.45};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
    ...
    public void testCase2() {
        Double[] originalInput1_1 = {-2.34, 3.67, 4.89};
        Double[] originalInput1_2 = {-1.45, 0.56, 2.78};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase3() {
        Double[] originalInput1_1 = {1.12, -1.44, 1.67};
        Double[] originalInput1_2 = {-1.78, 1.56, 1.89};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase4() {
        Double[] originalInput1_1 = {1.88, 2.53, 3.11};
        Double[] originalInput1_2 = {2.11, 3.88, 4.53};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase5() {
        Double[] originalInput1_1 = {0.13, -0.25, 0.38};
        Double[] originalInput1_2 = {-1.40, 1.55, -1.70};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase6() {
        Double[] originalInput1_1 = {-2.67, 2.88, 3.01};
        Double[] originalInput1_2 = {2.22, -2.33, 2.44};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase7() {
        Double[] originalInput1_1 = {3.14, -5.25, 2.78};
        Double[] originalInput1_2 = {1.35, -2.55, 1.65};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase8() {
        Double[] originalInput1_1 = {0.43, -0.56, 0.78};
        Double[] originalInput1_2 = {-0.33, 0.67, -0.54};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase9() {
        Double[] originalInput1_1 = {2.55, 0.95, 1.85};
        Double[] originalInput1_2 = {1.85, 2.10, 0.85};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase10() {
        Double[] originalInput1_1 = {5.23, -5.34, 5.45, -5.56};
        Double[] originalInput1_2 = {1.15, -1.25, 1.35, -1.45};
        double originalResult = cosineDistance.cosineDistance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}