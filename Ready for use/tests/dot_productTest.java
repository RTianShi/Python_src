import example.dot_product;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class dot_productTest {

    private void applyMR_Assert(Integer[] originalInput1_1, Integer[] originalInput1_2, int originalResult) {
        //MR1:数组元置换（打乱顺序）
        ...
        int transformResult1 = dot_product.dot_product_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        int transformResult2 = dot_product.dot_product_m(transformInput2_1, transformInput2_2);
        ...
        int transformResult3_1 = dot_product.dot_product_m(transformInput3_1, transformInput3_2);
        ...
        int transformResult3_2 = dot_product.dot_product_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        int transformResult4 = dot_product.dot_product_m(transformInput4_3, transformInput4_4);
        //MR5:数组缩放变换
        ...
        int transformResult5 = dot_product.dot_product_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        int transformResult6 = dot_product.dot_product_m(transformInput6_1, transformInput6_2);
        ...
        int transformResult7_1 = dot_product.dot_product_m(transformInput7_1, transformInput7_2);
        ...
        int transformResult7_2 = dot_product.dot_product_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        int transformResult8 = dot_product.dot_product_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        int transformResult9 = dot_product.dot_product_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        int transformResult10 = dot_product.dot_product_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        int transformResult11 = dot_product.dot_product_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        int transformResult12 = dot_product.dot_product_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
...
//        System.out.println("转换后的数组应该是：" + Arrays.toString(transformInput13_1));
//        System.out.println("转换后的数组应该是：" + Arrays.toString(transformInput13_2));
        int transformResult13 = dot_product.dot_product_m(transformInput13_3, transformInput13_4);
        //MR14:移除元素的效果（移除最大值）
        ...
        int transformResult14 = dot_product.dot_product_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        int transformResult15 = dot_product.dot_product_m(transformInput15_3, transformInput15_4);
        ...
        int transformResult16 = dot_product.dot_product_m(transformInput16_1, transformInput16_2);
        ...
        int transformResult19 = dot_product.dot_product_m(transformInput19_1, transformInput19_2);
        ...
        int transformResult20 = dot_product.dot_product_m(transformInput20_3, transformInput20_4);
        //MR22:应用恒等变换
        ...
        int transformResult22 = dot_product.dot_product_m(transformInput22_1, transformInput22_2);
//        //----------------------------------------------------------
...
//        assertTrue(originalResult <= transformResult19);
    ...
    public void testCase1() {
        Integer[] originalInput1_1 = {1, 2, 3, 4};
        Integer[] originalInput1_2 = {18, 19, 20, 21};
        int originalResult = dot_product.dot_product_m(originalInput1_1, originalInput1_2);
    ...
    public void testCase2() {
        Integer[] originalInput1_1 = {8, 9, 9, 9, 8};
        Integer[] originalInput1_2 = {10, 6, 5, 6, 10};
        int originalResult = dot_product.dot_product_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase3() {
        Integer[] originalInput1_1 = {-2, 3, 4, -1, 0};
        Integer[] originalInput1_2 = {2, -1, 3, 4, -5};
        int originalResult = dot_product.dot_product_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase4() {
        Integer[] originalInput1_1 = {2, 4, 6, 8};
        Integer[] originalInput1_2 = {8, 6, 4, 3};
        int originalResult = dot_product.dot_product_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase5() {
        Integer[] originalInput1_1 = {5, 5, 5, 5};
        Integer[] originalInput1_2 = {7, 7, 7, 7};
        int originalResult = dot_product.dot_product_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase6() {
        Integer[] originalInput1_1 = {0, 0, 0, 0};
        Integer[] originalInput1_2 = {1, 1, 1, 1};
        int originalResult = dot_product.dot_product_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase7() {
        Integer[] originalInput1_1 = {0, 1, 4, 1, 0};
        Integer[] originalInput1_2 = {1, 0, 4, 0, 1};
        int originalResult = dot_product.dot_product_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase8() {
        Integer[] originalInput1_1 = {2, 5, 8, 11, 14};
    ...
    public void testCase9() {
        Integer[] originalInput1_1 = {-1, 1, 3, 5, 7};
        Integer[] originalInput1_2 = {0, 1, 2, 3, 4};
        int originalResult = dot_product.dot_product_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase10() {
        Integer[] originalInput1_1 = {7, -5, 4, -3, 2};
