...
//        assertTrue(originalResult <= transformResult20);
    ...
    @Test
    public void testKurtosis1() {
        Double[] originalInput = {4.11, 4.22, 4.33};
        double originalResult = kurtosis.kurtosis_m(originalInput);
    ...
    @Test
    public void testKurtosis3() {
        Double[] originalInput = {35.12, 36.12, 37.12};
        double originalResult = kurtosis.kurtosis_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    @Test
    public void testKurtosis4() {
        Double[] originalInput = {4.55, 3.55, 2.55, 1.55};
        double originalResult = kurtosis.kurtosis_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    ...
    @Test
    public void testKurtosis7() {
        Double[] originalInput = {0.0001, 0.0002, 0.0003, 0.0004, 0.0005};
        double originalResult = kurtosis.kurtosis_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testKurtosis8() {
        Double[] originalInput = {2.78, 3.66, 2.10, 3.52, 2.89, 3.46};
        double originalResult = kurtosis.kurtosis_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testKurtosis9() {
        Double[] originalInput = {50.1, 40.2, 30.3, 20.4, 10.5};
        double originalResult = kurtosis.kurtosis_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testKurtosis10() {
