...
//        int transformResult15 =     sum.    sum_m(transformInput15);
        ...
        double transformResult20 = sum.sum_m(transformInput20_1);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        int transformResult22 = sum.sum_m(transformInput22);
        //----------------------------------------------------------
//        //OR1:和应该保持不变
...
//        assertTrue(originalResult <= transformResult19);
    ...
    public void testSumCase1() {
        ...
        int originalResult = sum.sum_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testSumCase2() {
        Integer[] originalInput = {5, 8, 3, 4, 9};
        int originalResult = sum.sum_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testSumCase7() {
        Integer[] originalInput = {-5, -10, 5, 10};
        int originalResult = sum.sum_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testSumCase8() {
    ...
    @Test
    public void testSumCase9() {
        Integer[] originalInput = {3, 6, 9, 12};
        int originalResult = sum.sum_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testSumCase10() {
        Integer[] originalInput = {11, 22, 33, 44};
        int originalResult = sum.sum_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
}