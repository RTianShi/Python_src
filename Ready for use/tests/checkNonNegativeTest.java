...
public class checkNonNegativeTest {
...
//        assertTrue(originalResult >= transformResult15);
    ...
    public void testCase1() {
        final double[] originalInput = {1.0, 2.0, 3.0};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testCase2() {
        final double[] originalInput = {0.0, 1.5, 2.5};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase3() {
        final double[] originalInput = {-1.0, 0.0, 1.0};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase4() {
        final double[] originalInput = {5.0, 6.0};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase5() {
        final double[] originalInput = {-2.0, 4.0, 6.0};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase6() {
        final double[] originalInput = {0.5, 0.0, 1.5};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase7() {
        final double[] originalInput = {3.0, 7.0, 9.0};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase8() {
        final double[] originalInput = {-0.1, 2.0};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase9() {
        final double[] originalInput = {10.0, 15.0, 20.0, 25.0};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase10() {
        final double[] originalInput = {-3.0, -2.0, -1.0};
        boolean originalResult = checkNonNegative.checkNonNegative_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
}