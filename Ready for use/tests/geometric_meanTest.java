import example.geometric_mean;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class geometric_meanTest {
    ...
    private void applyMR_Assert(Integer[] originalInput, double originalResult) {
        ...
        double transformResult1 = geometric_mean.geometric_mean_m(transformInput1);
        //MR2:数组元素常数加法
        Integer[] transformInput2 = MetamorphicTestGenerator1.applyMR2(originalInput);
        double transformResult2 = geometric_mean.geometric_mean_m(transformInput2);
        //MR3_1:加入单位元不变性（加法的单位元0）
        Integer[] transformInput3_1 = MetamorphicTestGenerator1.applyMR3_1(originalInput);
        double transformResult3_1 = geometric_mean.geometric_mean_m(transformInput3_1);
        //MR3_2:加入单位元不变性（乘法的单位元1）
        Integer[] transformInput3_2 = MetamorphicTestGenerator1.applyMR3_2(originalInput);
        double transformResult3_2 = geometric_mean.geometric_mean_m(transformInput3_2);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = geometric_mean.geometric_mean_m(transformInput4_1);
        //MR5:数组缩放变换
        Integer[] transformInput5 = MetamorphicTestGenerator1.applyMR5(originalInput, 2);
        double transformResult5 = geometric_mean.geometric_mean_m(transformInput5);
        //MR6:数组反转变换
        Integer[] transformInput6 = MetamorphicTestGenerator1.applyMR6(originalInput);
        double transformResult6 = geometric_mean.geometric_mean_m(transformInput6);
        //MR7_1:中立操作的恒等变换（所有元素乘以1）
        Integer[] transformInput7_1 = MetamorphicTestGenerator1.applyMR7_1(originalInput);
        double transformResult7_1 = geometric_mean.geometric_mean_m(transformInput7_1);
        //MR7_2:中立操作的恒等变换（所有元素加上0）
        Integer[] transformInput7_2 = MetamorphicTestGenerator1.applyMR7_2(originalInput);
        double transformResult7_2 = geometric_mean.geometric_mean_m(transformInput7_2);
        //MR8:重复输入数组
        Integer[] transformInput8 = MetamorphicTestGenerator1.applyMR8(originalInput);
        double transformResult8 = geometric_mean.geometric_mean_m(transformInput8);
        //MR9:复合转换一致性
        Integer[] transformInput9 = MetamorphicTestGenerator1.applyMR9(originalInput, 3);
        double transformResult9 = geometric_mean.geometric_mean_m(transformInput9);
        //MR10:单调性检验
        Integer[] transformInput10 = MetamorphicTestGenerator1.applyMR10(originalInput);
        double transformResult10 = geometric_mean.geometric_mean_m(transformInput10);
        //MR11:边界值替换(把最大值替换成0)
        Integer[] transformInput11 = MetamorphicTestGenerator1.applyMR11(originalInput);
        double transformResult11 = geometric_mean.geometric_mean_m(transformInput11);
        //MR12:数值取反变换
        Integer[] transformInput12 = MetamorphicTestGenerator1.applyMR12(originalInput);
        double transformResult12 = geometric_mean.geometric_mean_m(transformInput12);
        //MR13:微小增量调整
        ...
        double transformResult13 = geometric_mean.geometric_mean_m(transformInput13_1);
        //MR14:移除元素的效果（移除最大值）
//        Integer[] transformInput14 = MetamorphicTestGenerator1.applyMR14(originalInput);
//        double transformResult14 = geometric_mean.geometric_mean_m(transformInput14);
        //MR15:类三角函数的周期性
//        Integer[] transformInput15 = MetamorphicTestGenerator1.applyMR15(originalInput);
//        double transformResult15 =    geometric_mean.   geometric_mean_m(transformInput15);
        //MR16:重复值稳健性(复制输入中的一个元素)
        Integer[] transformInput16 = MetamorphicTestGenerator1.applyMR16(originalInput);
        double transformResult16 = geometric_mean.geometric_mean_m(transformInput16);
        //MR19:输入重复（元素复制）将元素a重复多次插入序列中
//        Integer[] transformInput19 = MetamorphicTestGenerator1.applyMR19(originalInput, 2);
//        double transformResult19 =    geometric_mean.   geometric_mean_m(transformInput19);
        ...
        double transformResult20 = geometric_mean.geometric_mean_m(transformInput20_1);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        double transformResult22 = geometric_mean.geometric_mean_m(transformInput22);
        //----------------------------------------------------------
//        //OR1:和应该保持不变
...
//        assertTrue(originalResult == transformResult19);
    ...
    public void testCase1() {
        Integer[] originalInput = {2, 4, 8, 16};
        double originalResult = geometric_mean.geometric_mean_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testCase2() {
        Integer[] originalInput = {5, 10, 15};
        double originalResult = geometric_mean.geometric_mean_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase4() {
        Integer[] originalInput = {100, 200, 300, 400, 500};
        double originalResult = geometric_mean.geometric_mean_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase6() {
        Integer[] originalInput = {2, 3, 5, 7, 11};
        double originalResult = geometric_mean.geometric_mean_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase8() {
        Integer[] originalInput = {24, 35, 44, 55};
        double originalResult = geometric_mean.geometric_mean_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase9() {
        Integer[] originalInput = {1000, 500, 100};
        double originalResult = geometric_mean.geometric_mean_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase10() {
        Integer[] originalInput = {1, 1000000, 500000};
        double originalResult = geometric_mean.geometric_mean_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
}