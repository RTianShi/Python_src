import example.sampleWeightedVar;
import org.junit.Test;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

public class sampleWeightedVarTest {
    ...
    private void applyMR_Assert(Double[] originalInput1_1, Double[] originalInput1_2, double originalResult) {
        ...
        double transformResult1 = sampleWeightedVar.sampleWeightedVar_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double transformResult2 = sampleWeightedVar.sampleWeightedVar_m(transformInput2_1, transformInput2_2);
        ...
        double transformResult3_1 = sampleWeightedVar.sampleWeightedVar_m(transformInput3_1, transformInput3_2);
        ...
        double transformResult3_2 = sampleWeightedVar.sampleWeightedVar_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = sampleWeightedVar.sampleWeightedVar_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        double transformResult5 = sampleWeightedVar.sampleWeightedVar_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double transformResult6 = sampleWeightedVar.sampleWeightedVar_m(transformInput6_1, transformInput6_2);
        ...
        double transformResult7_1 = sampleWeightedVar.sampleWeightedVar_m(transformInput7_1, transformInput7_2);
        ...
        double transformResult7_2 = sampleWeightedVar.sampleWeightedVar_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double transformResult8 = sampleWeightedVar.sampleWeightedVar_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double transformResult9 = sampleWeightedVar.sampleWeightedVar_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double transformResult10 = sampleWeightedVar.sampleWeightedVar_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double transformResult11 = sampleWeightedVar.sampleWeightedVar_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double transformResult12 = sampleWeightedVar.sampleWeightedVar_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double transformResult13 = sampleWeightedVar.sampleWeightedVar_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
...
//        double transformResult14 = sampleWeightedVar.sampleWeightedVar_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double transformResult15 = sampleWeightedVar.sampleWeightedVar_m(transformInput15_1, transformInput15_2);
        ...
        double transformResult16 = sampleWeightedVar.sampleWeightedVar_m(transformInput16_1, transformInput16_2);
        ...
        double transformResult19 = sampleWeightedVar.sampleWeightedVar_m(transformInput19_1, transformInput19_2);
        ...
        double transformResult20 = sampleWeightedVar.sampleWeightedVar_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        double transformResult22 = sampleWeightedVar.sampleWeightedVar_m(transformInput22_1, transformInput22_2);
        //----------------------------------------------------------
...
//        assertTrue(originalResult >= transformResult20);
    ...
    @Test
    public void testSampleWeightedVarCase1() {
        Double[] originalInput1_1 = {1.0, 2.0, 3.0, 4.0};
        Double[] originalInput1_2 = {0.5, 1.5, 2.5, 3.5};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testSampleWeightedVarCase2() {
        Double[] originalInput1_1 = {1.1, 2.2, 3.3, 4.4};
        Double[] originalInput1_2 = {1.5, 1.06, 1.07, 1.08};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testSampleWeightedVarCase3() {
        Double[] originalInput1_1 = {1.05, 0.05, 1.05, 2.05};
        Double[] originalInput1_2 = {3.26, 4.26, 5.27, 6.27};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testSampleWeightedVarCase4() {
    ...
    @Test
    public void testSampleWeightedVarCase5() {
        Double[] originalInput1_1 = {0.0001, 0.0002, 0.0003, 0.0004};
        Double[] originalInput1_2 = {10.0, 20.0, 30.0, 40.0};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testSampleWeightedVarCase6() {
        Double[] originalInput1_1 = {7.1234, 8.2345, 9.3456};
        Double[] originalInput1_2 = {0.5, 1.0, 1.5};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testSampleWeightedVarCase7() {
        Double[] originalInput1_1 = {-5.0, -4.0, -3.0, -2.0, -1.0};
        Double[] originalInput1_2 = {2.0, 1.5, 1.0, 0.5, 0.2};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testSampleWeightedVarCase8() {
        Double[] originalInput1_1 = {100.0, 200.0, 300.0};
        Double[] originalInput1_2 = {3.0, 2.0, 1.0};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testSampleWeightedVarCase9() {
        Double[] originalInput1_1 = {3.14, 2.71, 1.61, 1.41};
        Double[] originalInput1_2 = {1.0, 1.0, 1.0, 1.0};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testSampleWeightedVarCase10() {
        Double[] originalInput1_1 = {4.1, 5.2, 6.3, 7.4, 8.5};
        Double[] originalInput1_2 = {1.5, 5.5, 10.5, 15.5, 20.5};
        double originalResult = sampleWeightedVar.sampleWeightedVar_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}