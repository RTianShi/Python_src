import example.find_median;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class find_medianTest {
    ...
    private void applyMR_Assert(Integer[] originalInput, double originalResult) {
        ...
        double transformResult1 = find_median.find_median_m(transformInput1);
        //MR2:数组元素常数加法
        Integer[] transformInput2 = MetamorphicTestGenerator1.applyMR2(originalInput);
        double transformResult2 = find_median.find_median_m(transformInput2);
        //MR3_1:加入单位元不变性（加法的单位元0）
        Integer[] transformInput3_1 = MetamorphicTestGenerator1.applyMR3_1(originalInput);
        double transformResult3_1 = find_median.find_median_m(transformInput3_1);
        //MR3_2:加入单位元不变性（乘法的单位元1）
        Integer[] transformInput3_2 = MetamorphicTestGenerator1.applyMR3_2(originalInput);
        double transformResult3_2 = find_median.find_median_m(transformInput3_2);
        //MR4:数组元素取倒数
...
//        int transformResult19 =   find_median.  find_median_m(transformInput19);
        ...
        double transformResult20 = find_median.find_median_m(transformInput20_1);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        double transformResult22 = find_median.find_median_m(transformInput22);
        //----------------------------------------------------------
...
//        assertTrue(originalResult >= transformResult15);
    ...
    public void testCase1() {
        ...
        double originalResult = find_median.find_median_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testCase2() {
        Integer[] originalInput = {-5, -2, 0, 2, 5};
        double originalResult = find_median.find_median_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase3() {
        Integer[] originalInput = {10, 20, 30, 40, 50, 60};
        double originalResult = find_median.find_median_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase5() {
        Integer[] originalInput = {11, 31, 51, 71, 91};
        double originalResult = find_median.find_median_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase6() {
        Integer[] originalInput = {100, 1, 50, 25, 75};
        double originalResult = find_median.find_median_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase8() {
        Integer[] originalInput = {1, 1, 1, 1, 1, 1};
        double originalResult = find_median.find_median_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase9() {
        Integer[] originalInput = {-100, -50, 0, 50, 100};
        double originalResult = find_median.find_median_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase10() {
        Integer[] originalInput = {7, 3, 9, 1, 2, 6, 5};
        double originalResult = find_median.find_median_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
}