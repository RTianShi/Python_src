import example.mean_abs_error;
import org.junit.Test;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

public class mean_abs_errorTest {
...
//MR1:数组元置换（打乱顺序）
        ...
        double transformResult1 = mean_abs_error.mean_abs_error_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double transformResult2 = mean_abs_error.mean_abs_error_m(transformInput2_1, transformInput2_2);
        ...
        double transformResult3_1 = mean_abs_error.mean_abs_error_m(transformInput3_1, transformInput3_2);
        ...
        double transformResult3_2 = mean_abs_error.mean_abs_error_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = mean_abs_error.mean_abs_error_m(transformInput4_3, transformInput4_4);
        //MR5:数组缩放变换
        ...
        double transformResult5 = mean_abs_error.mean_abs_error_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double transformResult6 = mean_abs_error.mean_abs_error_m(transformInput6_1, transformInput6_2);
        ...
        double transformResult7_1 = mean_abs_error.mean_abs_error_m(transformInput7_1, transformInput7_2);
        ...
        double transformResult7_2 = mean_abs_error.mean_abs_error_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double transformResult8 = mean_abs_error.mean_abs_error_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double transformResult9 = mean_abs_error.mean_abs_error_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double transformResult10 = mean_abs_error.mean_abs_error_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double transformResult11 = mean_abs_error.mean_abs_error_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double transformResult12 = mean_abs_error.mean_abs_error_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double transformResult13 = mean_abs_error.mean_abs_error_m(transformInput13_3, transformInput13_4);
        //MR14:移除元素的效果（移除最大值）
...
//          double transformResult14 =   mean_abs_error.  mean_abs_error_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double transformResult15 = mean_abs_error.mean_abs_error_m(transformInput15_3, transformInput15_4);
        ...
        double transformResult16 = mean_abs_error.mean_abs_error_m(transformInput16_1, transformInput16_2);
        ...
        double transformResult19 = mean_abs_error.mean_abs_error_m(transformInput19_1, transformInput19_2);
        ...
        double transformResult20 = mean_abs_error.mean_abs_error_m(transformInput20_3, transformInput20_4);
        //MR22:应用恒等变换
        ...
        double transformResult22 = mean_abs_error.mean_abs_error_m(transformInput22_1, transformInput22_2);
//        //----------------------------------------------------------
...
//        assertTrue(originalResult >= transformResult19);
    ...
    @Test
    public void testMeanAbsError_1() {
        Integer[] originalInput1_1 = {1, 2, 3, 4, 5};
        Integer[] originalInput1_2 = {5, 4, 3, 2, 1};
        double originalResult = mean_abs_error.mean_abs_error_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testMeanAbsError_2() {
        Integer[] originalInput1_1 = {-1, -2, -3, -4, -5};
        Integer[] originalInput1_2 = {-5, -4, -3, -2, -1};
        double originalResult = mean_abs_error.mean_abs_error_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    ...
    @Test
    public void testMeanAbsError_3() {
        Integer[] originalInput1_1 = {0, 0, 0, 0, 0};
        Integer[] originalInput1_2 = {0, 0, 0, 0, 0};
        double originalResult = mean_abs_error.mean_abs_error_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testMeanAbsError_4() {
        Integer[] originalInput1_1 = {1, 2, 3, 4, 5};
    ...
    @Test
    public void testMeanAbsError_5() {
        Integer[] originalInput1_1 = {5, 5, 5, 5, 5};
    ...
    @Test
    public void testMeanAbsError_6() {
        Integer[] originalInput1_1 = {10, 20, 30, 40, 50};
        Integer[] originalInput1_2 = {50, 40, 30, 20, 10};
        double originalResult = mean_abs_error.mean_abs_error_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testMeanAbsError_7() {
        Integer[] originalInput1_1 = {-1, -2, -3, -4, -5};
        Integer[] originalInput1_2 = {1, 2, 3, 4, 5};
        double originalResult = mean_abs_error.mean_abs_error_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    ...
    @Test
    public void testMeanAbsError_8() {
        Integer[] originalInput1_1 = {1000, 2000, 3000, 4000, 5000};
        Integer[] originalInput1_2 = {5000, 4000, 3000, 2000, 1000};
        double originalResult = mean_abs_error.mean_abs_error_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testMeanAbsError_9() {
        Integer[] originalInput1_1 = {1, 2, 3, 4, 5};
        Integer[] originalInput1_2 = {5, 5, 5, 5, 5};
        double originalResult = mean_abs_error.mean_abs_error_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testMeanAbsError_10() {
        Integer[] originalInput1_1 = {1, -1, 2, -2, 3, -3};
        Integer[] originalInput1_2 = {1, 1, 2, 2, 3, 3};
        double originalResult = mean_abs_error.mean_abs_error_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}