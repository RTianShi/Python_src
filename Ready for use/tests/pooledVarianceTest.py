import example.pooledVariance;
import org.junit.Test;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

public class pooledVarianceTest {
    ...
    private void applyMR_Assert(Double[] originalInput1_1, Double[] originalInput1_2, double originalResult) {
        ...
        double transformResult1 = pooledVariance.pooledVariance_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double transformResult2 = pooledVariance.pooledVariance_m(transformInput2_1, transformInput2_2);
        ...
        double transformResult3_1 = pooledVariance.pooledVariance_m(transformInput3_1, transformInput3_2);
        ...
        double transformResult3_2 = pooledVariance.pooledVariance_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = pooledVariance.pooledVariance_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        double transformResult5 = pooledVariance.pooledVariance_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double transformResult6 = pooledVariance.pooledVariance_m(transformInput6_1, transformInput6_2);
        ...
        double transformResult7_1 = pooledVariance.pooledVariance_m(transformInput7_1, transformInput7_2);
        ...
        double transformResult7_2 = pooledVariance.pooledVariance_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double transformResult8 = pooledVariance.pooledVariance_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double transformResult9 = pooledVariance.pooledVariance_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double transformResult10 = pooledVariance.pooledVariance_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double transformResult11 = pooledVariance.pooledVariance_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double transformResult12 = pooledVariance.pooledVariance_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double transformResult13 = pooledVariance.pooledVariance_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
        ...
        double transformResult14 = pooledVariance.pooledVariance_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double transformResult15 = pooledVariance.pooledVariance_m(transformInput15_1, transformInput15_2);
        ...
        double transformResult16 = pooledVariance.pooledVariance_m(transformInput16_1, transformInput16_2);
        ...
        double transformResult19 = pooledVariance.pooledVariance_m(transformInput19_1, transformInput19_2);
        ...
        double transformResult20 = pooledVariance.pooledVariance_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        double transformResult22 = pooledVariance.pooledVariance_m(transformInput22_1, transformInput22_2);
        //----------------------------------------------------------
...
//        assertTrue(originalResult <= transformResult20);
    ...
    @Test
    public void testPooledVariance_1() {
        Double[] originalInput1_1 = {1.0, 2.0, 3.0};
        Double[] originalInput1_2 = {4.0, 5.0, 6.0, 7.0};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);

    }

    @Test
    public void testPooledVariance_2() {
        Double[] originalInput1_1 = {10.5, 20.5};
        Double[] originalInput1_2 = {30.5, 40.5, 50.5};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledVariance_3() {
        Double[] originalInput1_1 = {-1.1, 0.0, 1.1};
        Double[] originalInput1_2 = {-2.2, 2.2};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledVariance_4() {
        Double[] originalInput1_1 = {100.0};
        Double[] originalInput1_2 = {200.0, 300.0};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledVariance_5() {
        Double[] originalInput1_1 = {1.123456789, 2.123456789, 3.123456789};
        Double[] originalInput1_2 = {4.987654321, 5.987654321};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledVariance_6() {
        Double[] originalInput1_1 = {5.1, 6.2};
        Double[] originalInput1_2 = {5.3, 6.4, 7.5, 8.6};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledVariance_7() {
        Double[] originalInput1_1 = {5.5, 6.5};
        Double[] originalInput1_2 = {7.5, 8.5, 9.5, 10.5, 11.5};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledVariance_8() {
        Double[] originalInput1_1 = {0.0, 1.0, 2.0};
        Double[] originalInput1_2 = {3.0, 4.0};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledVariance_9() {
        Double[] originalInput1_1 = {1.15, 2.25, 3.35, 4.45};
        Double[] originalInput1_2 = {7.869, 6.666};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testPooledVariance_10() {
        Double[] originalInput1_1 = {-3.14, 0.0, 3.14};
        Double[] originalInput1_2 = {-6.28, 6.28, 0.0};
        double originalResult = pooledVariance.pooledVariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}