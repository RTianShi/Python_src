import example.cal_DividedDiff;
...
public class cal_DividedDiffTest {
    private void applyMR_Assert(final double[] originalInput1_1, final double[] originalInput1_2, double[] originalResult) {
        ...
        double[] transformResult1 = cal_DividedDiff.cal_DividedDiff_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double[] transformResult2 = cal_DividedDiff.cal_DividedDiff_m(transformInput2_1, transformInput2_2);
        ...
        double[] transformResult3_1 = cal_DividedDiff.cal_DividedDiff_m(transformInput3_1, transformInput3_2);
        ...
        double[] transformResult3_2 = cal_DividedDiff.cal_DividedDiff_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double[] transformResult4 = cal_DividedDiff.cal_DividedDiff_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        double[] transformResult5 = cal_DividedDiff.cal_DividedDiff_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double[] transformResult6 = cal_DividedDiff.cal_DividedDiff_m(transformInput6_1, transformInput6_2);
        ...
        double[] transformResult7_1 = cal_DividedDiff.cal_DividedDiff_m(transformInput7_1, transformInput7_2);
        ...
        double[] transformResult7_2 = cal_DividedDiff.cal_DividedDiff_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double[] transformResult8 = cal_DividedDiff.cal_DividedDiff_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double[] transformResult9 = cal_DividedDiff.cal_DividedDiff_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double[] transformResult10 = cal_DividedDiff.cal_DividedDiff_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double[] transformResult11 = cal_DividedDiff.cal_DividedDiff_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double[] transformResult12 = cal_DividedDiff.cal_DividedDiff_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double[] transformResult13 = cal_DividedDiff.cal_DividedDiff_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
        ...
        double[] transformResult14 = cal_DividedDiff.cal_DividedDiff_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double[] transformResult15 = cal_DividedDiff.cal_DividedDiff_m(transformInput15_1, transformInput15_2);
        ...
        double[] transformResult16 = cal_DividedDiff.cal_DividedDiff_m(transformInput16_1, transformInput16_2);
        ...
        double[] transformResult19 = cal_DividedDiff.cal_DividedDiff_m(transformInput19_1, transformInput19_2);
        ...
        double[] transformResult20 = cal_DividedDiff.cal_DividedDiff_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        double[] transformResult22 = cal_DividedDiff.cal_DividedDiff_m(transformInput22_1, transformInput22_2);
        //----------------------------------------------------------
//        //OR1:和应该保持不变
...
//        assertTrue(formatArray(originalResult, 2) <= transformResult20);
    ...
    public void testCase1() {
        ...
        double[] originalResult = cal_DividedDiff.cal_DividedDiff_m(originalInput1_1, originalInput1_2);
    ...
    public void testCase3() {
        ...
        final double[] originalResult = cal_DividedDiff.cal_DividedDiff_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
