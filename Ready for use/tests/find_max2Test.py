import example.find_max2;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class find_max2Test {
...
//        int transformResult19 =  find_max2. find_max2_m(transformInput19);
        ...
        double transformResult20 = find_max2.find_max2_m(transformInput20_1);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        int transformResult22 = find_max2.find_max2_m(transformInput22);
        //----------------------------------------------------------
//        //OR1:和应该保持不变
...
//        assertTrue(originalResult >= transformResult15);
    ...
    public void testCase1() {
        ...
        int originalResult = find_max2.find_max2_m(originalInput);
    ...
    public void testCase3() {
        Integer[] originalInput = {10, -25, 35, -40, -55};
        int originalResult = find_max2.find_max2_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase4() {
        Integer[] originalInput = {7, 2, 14, 1, 6};
        int originalResult = find_max2.find_max2_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase6() {
        Integer[] originalInput = {3, 1, 4, 2, 5};
        int originalResult = find_max2.find_max2_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase7() {
        Integer[] originalInput = {5, 1, 7, 9, 2};
        int originalResult = find_max2.find_max2_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase8() {
        Integer[] originalInput = {8, 15, 7, 22, 5};
        int originalResult = find_max2.find_max2_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase9() {
        Integer[] originalInput = {51, 11, -62, -45, -70};
        int originalResult = find_max2.find_max2_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase10() {
        Integer[] originalInput = {9, 4, 6, 2, 7};
        int originalResult = find_max2.find_max2_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
}