...
def applyMR_Assert(originalInput1_1, originalInput1_2, originalResult):
    ...
    check.almost_equal(originalResult, transformResult6, delta=delta, msg="MR6 failed")
    ...
    check.almost_equal(originalResult, transformResult20, delta=delta, msg="MR20 failed")
