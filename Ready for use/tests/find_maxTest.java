...
//        int transformResult15 =   find_max.  find_max_m(transformInput15);
        ...
        double transformResult20 = find_max.find_max_m(transformInput20_1);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        int transformResult22 = find_max.find_max_m(transformInput22);
        //----------------------------------------------------------
//        //OR1:和应该保持不变
...
//        assertTrue(originalResult >= transformResult15);
    ...
    public void testCase1() {
        ...
        int originalResult = find_max.find_max_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testCase2() {
        Integer[] originalInput = {10, 50, 80, 30, 60};
        int originalResult = find_max.find_max_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase6() {
        Integer[] originalInput = {3, 1, 3, 3, 3};
        int originalResult = find_max.find_max_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase9() {
        Integer[] originalInput = {-52, 12, -62, 32, 72};
        int originalResult = find_max.find_max_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
