import example.hamming_dist;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class hamming_distTest {
...
//MR1:数组元置换（打乱顺序）
        ...
        int transformResult1 = hamming_dist.hamming_dist_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        int transformResult2 = hamming_dist.hamming_dist_m(transformInput2_1, transformInput2_2);
        ...
        int transformResult3_1 = hamming_dist.hamming_dist_m(transformInput3_1, transformInput3_2);
        ...
        int transformResult3_2 = hamming_dist.hamming_dist_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        int transformResult4 = hamming_dist.hamming_dist_m(transformInput4_3, transformInput4_4);
        //MR5:数组缩放变换
        ...
        int transformResult5 = hamming_dist.hamming_dist_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        int transformResult6 = hamming_dist.hamming_dist_m(transformInput6_1, transformInput6_2);
        ...
        int transformResult7_1 = hamming_dist.hamming_dist_m(transformInput7_1, transformInput7_2);
        ...
        int transformResult7_2 = hamming_dist.hamming_dist_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        int transformResult8 = hamming_dist.hamming_dist_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        int transformResult9 = hamming_dist.hamming_dist_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        int transformResult10 = hamming_dist.hamming_dist_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        int transformResult11 = hamming_dist.hamming_dist_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        int transformResult12 = hamming_dist.hamming_dist_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        int transformResult13 = hamming_dist.hamming_dist_m(transformInput13_3, transformInput13_4);
        //MR14:移除元素的效果（移除最大值）
...
//        int transformResult14 = hamming_dist.hamming_dist_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        int transformResult15 = hamming_dist.hamming_dist_m(transformInput15_3, transformInput15_4);
        ...
        int transformResult16 = hamming_dist.hamming_dist_m(transformInput16_1, transformInput16_2);
        ...
        int transformResult19 = hamming_dist.hamming_dist_m(transformInput19_1, transformInput19_2);
        ...
        int transformResult20 = hamming_dist.hamming_dist_m(transformInput20_3, transformInput20_4);
        //MR22:应用恒等变换
        ...
        int transformResult22 = hamming_dist.hamming_dist_m(transformInput22_1, transformInput22_2);
//        //----------------------------------------------------------
...
//        assertTrue(originalResult == transformResult20);
    ...
    @Test
    public void testHammingDist1() {
        Integer[] originalInput1_1 = {1, 2, 3, 4, 5};
        Integer[] originalInput1_2 = {1, 2, 3, 4, 5};
        int originalResult = hamming_dist.hamming_dist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testHammingDist2() {
        Integer[] originalInput1_1 = {1, 0, 1, 0, 1};
        Integer[] originalInput1_2 = {0, 1, 0, 1, 0};
        int originalResult = hamming_dist.hamming_dist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    @Test
    public void testHammingDist5() {
        Integer[] originalInput1_1 = {1, 2, 3, 4, 5};
        Integer[] originalInput1_2 = {5, 4, 3, 2, 2};
        int originalResult = hamming_dist.hamming_dist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testHammingDist6() {
    ...
    @Test
    public void testHammingDist7() {
        Integer[] originalInput1_1 = {-1, 0, 1, 0, -1};
        Integer[] originalInput1_2 = {0, -1, 0, 1, 1};
        int originalResult = hamming_dist.hamming_dist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testHammingDist8() {
        Integer[] originalInput1_1 = {-1, -1, -1, -1, -1};
        Integer[] originalInput1_2 = {-1, -2, -2, -1, -1};
        int originalResult = hamming_dist.hamming_dist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testHammingDist9() {
        Integer[] originalInput1_1 = {1, 1, 1, 1, 1};
        Integer[] originalInput1_2 = {1, 1, 1, 0, 1};
        int originalResult = hamming_dist.hamming_dist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testHammingDist10() {
        Integer[] originalInput1_1 = {-1, 0, 1, -1, 0};
        Integer[] originalInput1_2 = {0, -1, -1, 1, 1};
        int originalResult = hamming_dist.hamming_dist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}