...
public class insertion_sortTest {
    ...
    private void applyMR_Assert(Integer[] originalInput, Integer[] originalResult) {
        ...
        Integer[] transformResult1 = insertion_sort.insertion_sort_m(transformInput1);
        //MR2:数组元素常数加法
        Integer[] transformInput2 = MetamorphicTestGenerator1.applyMR2(originalInput);
        Integer[] transformResult2 = insertion_sort.insertion_sort_m(transformInput2);
        //MR3_1:加入单位元不变性（加法的单位元0）
        Integer[] transformInput3_1 = MetamorphicTestGenerator1.applyMR3_1(originalInput);
        Integer[] transformResult3_1 = insertion_sort.insertion_sort_m(transformInput3_1);
        //MR3_2:加入单位元不变性（乘法的单位元1）
        Integer[] transformInput3_2 = MetamorphicTestGenerator1.applyMR3_2(originalInput);
        Integer[] transformResult3_2 = insertion_sort.insertion_sort_m(transformInput3_2);
        //MR4:数组元素取倒数
        ...
        Integer[] transformResult4 = insertion_sort.insertion_sort_m(transformInput4_1);
        //MR5:数组缩放变换
        Integer[] transformInput5 = MetamorphicTestGenerator1.applyMR5(originalInput, 2);
        Integer[] transformResult5 = insertion_sort.insertion_sort_m(transformInput5);
        //MR6:数组反转变换
        Integer[] transformInput6 = MetamorphicTestGenerator1.applyMR6(originalInput);
        Integer[] transformResult6 = insertion_sort.insertion_sort_m(transformInput6);
        //MR7_1:中立操作的恒等变换（所有元素乘以1）
        Integer[] transformInput7_1 = MetamorphicTestGenerator1.applyMR7_1(originalInput);
        Integer[] transformResult7_1 = insertion_sort.insertion_sort_m(transformInput7_1);
        //MR7_2:中立操作的恒等变换（所有元素加上0）
        Integer[] transformInput7_2 = MetamorphicTestGenerator1.applyMR7_2(originalInput);
        Integer[] transformResult7_2 = insertion_sort.insertion_sort_m(transformInput7_2);
        //MR8:重复输入数组
        Integer[] transformInput8 = MetamorphicTestGenerator1.applyMR8(originalInput);
        Integer[] transformResult8 = insertion_sort.insertion_sort_m(transformInput8);
        //MR9:复合转换一致性
        Integer[] transformInput9 = MetamorphicTestGenerator1.applyMR9(originalInput, 3);
        Integer[] transformResult9 = insertion_sort.insertion_sort_m(transformInput9);
        //MR10:单调性检验
        Integer[] transformInput10 = MetamorphicTestGenerator1.applyMR10(originalInput);
        Integer[] transformResult10 = insertion_sort.insertion_sort_m(transformInput10);
        //MR11:边界值替换(把最大值替换成0)
        Integer[] transformInput11 = MetamorphicTestGenerator1.applyMR11(originalInput);
        Integer[] transformResult11 = insertion_sort.insertion_sort_m(transformInput11);
        //MR12:数值取反变换
        Integer[] transformInput12 = MetamorphicTestGenerator1.applyMR12(originalInput);
        Integer[] transformResult12 = insertion_sort.insertion_sort_m(transformInput12);
        //MR13:微小增量调整
        ...
        Integer[] transformResult13 = insertion_sort.insertion_sort_m(transformInput13_1);
        //MR14:移除元素的效果（移除最大值）
        Integer[] transformInput14 = MetamorphicTestGenerator1.applyMR14(originalInput);
        Integer[] transformResult14 = insertion_sort.insertion_sort_m(transformInput14);
        //MR15:类三角函数的周期性
//        Integer[] transformInput15 = MetamorphicTestGenerator1.applyMR15(originalInput);
//        Integer[] transformResult15 = insertion_sort.insertion_sort_m(transformInput15);
        //MR16:重复值稳健性(复制输入中的一个元素)
        Integer[] transformInput16 = MetamorphicTestGenerator1.applyMR16(originalInput);
        Integer[] transformResult16 = insertion_sort.insertion_sort_m(transformInput16);
        //MR19:输入重复（元素复制）将元素a重复多次插入序列中
        Integer[] transformInput19 = MetamorphicTestGenerator1.applyMR19(originalInput, 2);
        Integer[] transformResult19 = insertion_sort.insertion_sort_m(transformInput19);
        ...
        Integer[] transformResult20 = insertion_sort.insertion_sort_m(transformInput20_1);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        Integer[] transformResult22 = insertion_sort.insertion_sort_m(transformInput22);
        //----------------------------------------------------------
...
//        assertTrue(originalResult <= transformResult20);
    ...
    public void testInsertionSort1() {
        ...
        Integer[] originalResult = insertion_sort.insertion_sort_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testInsertionSort2() {
        Integer[] originalInput = {5, 4, 3, 2, 1};
        Integer[] originalResult = insertion_sort.insertion_sort_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testInsertionSort3() {
        Integer[] originalInput = {3, 1, 4, 1, 5, 9};
        Integer[] originalResult = insertion_sort.insertion_sort_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testInsertionSort6() {
        Integer[] originalInput = {10, 2, 3, 10, 1, 5};
        Integer[] originalResult = insertion_sort.insertion_sort_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testInsertionSort7() {
        Integer[] originalInput = {4, 1, 3, 1, 2, 5};
        Integer[] originalResult = insertion_sort.insertion_sort_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testInsertionSort8() {
        Integer[] originalInput = {8, 6, 7, 9, 5, 4};
        Integer[] originalResult = insertion_sort.insertion_sort_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testInsertionSort9() {
        Integer[] originalInput = {0, 0, 1, 1, 2, 2, 3, 3};
        Integer[] originalResult = insertion_sort.insertion_sort_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testInsertionSort10() {
        Integer[] originalInput = {-3, -2, -1, 0, 1, 2, 3};
        Integer[] originalResult = insertion_sort.insertion_sort_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
}