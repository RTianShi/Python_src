...
def _mutmut_trampoline(orig, mutants, call_args, call_kwargs, self_arg = None):
    ...
    return result
def x_sequential_search__mutmut_orig(a, key):
    for i in range(0, len(a)):
        if a[i] == key:
            return i

    return -1
def x_sequential_search__mutmut_1(a, key):
    for i in range(None, len(a)):
        if a[i] == key:
            return i

    return -1
def x_sequential_search__mutmut_2(a, key):
    for i in range(0, None):
        if a[i] == key:
            return i

    return -1
def x_sequential_search__mutmut_3(a, key):
    for i in range(len(a)):
        if a[i] == key:
            return i

    return -1
def x_sequential_search__mutmut_4(a, key):
    for i in range(0, ):
        if a[i] == key:
            return i

    return -1
def x_sequential_search__mutmut_5(a, key):
    for i in range(1, len(a)):
        if a[i] == key:
            return i

    return -1
def x_sequential_search__mutmut_6(a, key):
    for i in range(0, len(a)):
        if a[i] != key:
            return i

    return -1
def x_sequential_search__mutmut_7(a, key):
    for i in range(0, len(a)):
        if a[i] == key:
            return i

    return +1
def x_sequential_search__mutmut_8(a, key):
    for i in range(0, len(a)):
        if a[i] == key:
            return i
