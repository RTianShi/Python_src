...
x_find_max__mutmut_mutants : ClassVar[MutantDict] = {
'x_find_max__mutmut_1': x_find_max__mutmut_1, 
    ...
    'x_find_max__mutmut_8': x_find_max__mutmut_8, 
    'x_find_max__mutmut_9': x_find_max__mutmut_9
}
