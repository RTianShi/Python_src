import example.cnt_zeroes;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class cnt_zeroesTest {
...
//        int transformResult19 = cnt_zeroes.cnt_zeroes_m(transformInput19);
        ...
        double transformResult20 = cnt_zeroes.cnt_zeroes_m(transformInput20_1);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        int transformResult22 = cnt_zeroes.cnt_zeroes_m(transformInput22);
        //----------------------------------------------------------
//        //OR1:和应该保持不变
...
//        assertTrue(originalResult  == transformResult2);
        //OR3_1:源输出加1等于后续输出
        assertTrue(originalResult + 1 == transformResult3_1);
        //OR3_2:和应该保持不变
...
//        assertTrue(originalResult >= transformResult15);
    ...
    public void testCase1() {
        Integer[] originalInput = {0, 1, 2, 0, 3};
        int originalResult = cnt_zeroes.cnt_zeroes_m(originalInput);
    ...
    public void testCase4() {
        Integer[] originalInput = {-1, 0, 1, 0, 0};
        int originalResult = cnt_zeroes.cnt_zeroes_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase6() {
        Integer[] originalInput = {0, 0, 1, 2, 0, 3, 0};
        int originalResult = cnt_zeroes.cnt_zeroes_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase7() {
        Integer[] originalInput = {4, 5, 6, 7, 0};
        int originalResult = cnt_zeroes.cnt_zeroes_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase9() {
        Integer[] originalInput = {0, 1, 0, 2, 0, 3, 0};
        int originalResult = cnt_zeroes.cnt_zeroes_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testCase10() {
        Integer[] originalInput = {0, 0, 0, 0, 0, 0, 0};
        int originalResult = cnt_zeroes.cnt_zeroes_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
