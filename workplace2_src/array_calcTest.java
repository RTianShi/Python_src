...
public class array_calcTest {
    private void applyMR_Assert(int[] originalInput, int[] originalResult, int k) {

        //MR1:数组元置换（打乱顺序）
//        int[] transformInput1 = MetamorphicTestGenerator2.applyMR1(originalInput);
//        int[] transformResult1 = array_calc.array_calc_m(transformInput1, 3);
        //MR2:数组元素常数加法
//        int[] transformInput2 = MetamorphicTestGenerator2.applyMR2(originalInput);
//        int[] transformResult2 = array_calc.array_calc_m(transformInput2, k);
        //MR3_1:加入单位元不变性（加法的单位元0）
//        int[] transformInput3_1 = MetamorphicTestGenerator2.applyMR3_1(originalInput);
//        int[] transformResult3_1 = array_calc.array_calc_m(transformInput3_1, k);
        //MR3_2:加入单位元不变性（乘法的单位元1）
//        int[] transformInput3_2 = MetamorphicTestGenerator2.applyMR3_2(originalInput);
//        int[] transformResult3_2 = array_calc.array_calc_m(transformInput3_2, k);
//        //MR4:数组元素取倒数
...
//        }
//        int[] transformResult20 = array_calc.array_calc_m(transformInput20_1, 2);
        //MR22:应用恒等变换
        int[] transformInput22 = MetamorphicTestGenerator2.applyMR22(originalInput);
        int[] transformResult22 = array_calc.array_calc_m(transformInput22, k);
        //----------------------------------------------------------
        //OR1:和应该保持不变
...
//        assertTrue(originalResult <= transformResult16);
    ...
    public void testCase1() {
        ...
        int k = 2;
        int[] originalResult = array_calc.array_calc_m(originalInput, k);
