...
chiSquareTest {
    ...
    private void applyMR_Assert(Double[] originalInput1_1, Double[] originalInput1_2, double originalResult) {
        ...
        double transformResult1 = chiSquare.chiSquare_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double transformResult2 = chiSquare.chiSquare_m(transformInput2_1, transformInput2_2);
        ...
        double transformResult3_1 = chiSquare.chiSquare_m(transformInput3_1, transformInput3_2);
        ...
        double transformResult3_2 = chiSquare.chiSquare_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = chiSquare.chiSquare_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        double transformResult5 = chiSquare.chiSquare_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double transformResult6 = chiSquare.chiSquare_m(transformInput6_1, transformInput6_2);
        ...
        double transformResult7_1 = chiSquare.chiSquare_m(transformInput7_1, transformInput7_2);
        ...
        double transformResult7_2 = chiSquare.chiSquare_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double transformResult8 = chiSquare.chiSquare_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double transformResult9 = chiSquare.chiSquare_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double transformResult10 = chiSquare.chiSquare_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double transformResult11 = chiSquare.chiSquare_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double transformResult12 = chiSquare.chiSquare_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double transformResult13 = chiSquare.chiSquare_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
        ...
        double transformResult14 = chiSquare.chiSquare_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double transformResult15 = chiSquare.chiSquare_m(transformInput15_1, transformInput15_2);
        ...
        double transformResult16 = chiSquare.chiSquare_m(transformInput16_1, transformInput16_2);
        ...
        double transformResult19 = chiSquare.chiSquare_m(transformInput19_1, transformInput19_2);
        ...
        double transformResult20 = chiSquare.chiSquare_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        double transformResult22 = chiSquare.chiSquare_m(transformInput22_1, transformInput22_2);
//        //----------------------------------------------------------
...
//        assertTrue(originalResult == transformResult3_1);
        //OR3_2:和应该增大或保持不变
//        System.out.println("转换前的数组应该是：" + originalResult);
//        System.out.println("转换后的数组应该是：" + transformResult3_2);
...
//        assertEquals(originalResult, transformResult15, delta);
    ...
    public void testCase1() {
        ...
        Double[] originalInput1_2 = {1.1, 2.0, 2.9};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testCase2() {
        Double[] originalInput1_1 = {4.5, 5.5, 6.5, 7.5};
        Double[] originalInput1_2 = {4.0, 5.0, 7.0, 8.0};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase3() {
        Double[] originalInput1_1 = {10.0, 15.0, 20.0};
        Double[] originalInput1_2 = {12.0, 14.0, 18.0};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase4() {
        Double[] originalInput1_1 = {8.0, 9.5, 11.0, 12.5};
        Double[] originalInput1_2 = {7.5, 9.0, 10.5, 13.0};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase5() {
        Double[] originalInput1_1 = {3.0, 4.0, 5.0};
        Double[] originalInput1_2 = {3.5, 4.5, 5.5};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase6() {
        Double[] originalInput1_1 = {6.0, 8.0, 10.0, 12.0};
        Double[] originalInput1_2 = {6.0, 8.2, 10.5, 11.5};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase7() {
        Double[] originalInput1_1 = {2.5, 4.0, 6.5};
        Double[] originalInput1_2 = {2.5, 4.2, 6.0};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase8() {
        Double[] originalInput1_1 = {7.0, 8.5, 9.0, 10.0};
        Double[] originalInput1_2 = {7.5, 8.0, 9.5, 10.5};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase9() {
        Double[] originalInput1_1 = {5.5, 7.5, 9.5};
        Double[] originalInput1_2 = {6.0, 7.0, 9.0};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase10() {
        Double[] originalInput1_1 = {15.0, 20.0, 25.0, 30.0};
        Double[] originalInput1_2 = {14.5, 19.5, 26.0, 31.0};
        double originalResult = chiSquare.chiSquare_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}