import example.ebeDivide;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class ebeDivideTest {
    ...
    private void applyMR_Assert(Double[] originalInput1_1, Double[] originalInput1_2, Double[] originalResult) {
        ...
        Double[] transformResult1 = ebeDivide.ebeDivide_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
...
//        System.out.println("转换后的数组应该是：" + Arrays.toString(transformInput2_2));
        Double[] transformResult2 = ebeDivide.ebeDivide_m(transformInput2_1, transformInput2_2);
        ...
        Double[] transformResult3_1 = ebeDivide.ebeDivide_m(transformInput3_1, transformInput3_2);
        ...
        Double[] transformResult3_2 = ebeDivide.ebeDivide_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        Double[] transformResult4 = ebeDivide.ebeDivide_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        Double[] transformResult5 = ebeDivide.ebeDivide_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        Double[] transformResult6 = ebeDivide.ebeDivide_m(transformInput6_1, transformInput6_2);
        ...
        Double[] transformResult7_1 = ebeDivide.ebeDivide_m(transformInput7_1, transformInput7_2);
        ...
        Double[] transformResult7_2 = ebeDivide.ebeDivide_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        Double[] transformResult8 = ebeDivide.ebeDivide_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        Double[] transformResult9 = ebeDivide.ebeDivide_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        Double[] transformResult10 = ebeDivide.ebeDivide_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        Double[] transformResult11 = ebeDivide.ebeDivide_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        Double[] transformResult12 = ebeDivide.ebeDivide_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        Double[] transformResult13 = ebeDivide.ebeDivide_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
        ...
        Double[] transformResult14 = ebeDivide.ebeDivide_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        Double[] transformResult15 = ebeDivide.ebeDivide_m(transformInput15_1, transformInput15_2);
        ...
        Double[] transformResult16 = ebeDivide.ebeDivide_m(transformInput16_1, transformInput16_2);
        ...
        Double[] transformResult19 = ebeDivide.ebeDivide_m(transformInput19_1, transformInput19_2);
        ...
        Double[] transformResult20 = ebeDivide.ebeDivide_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        Double[] transformResult22 = ebeDivide.ebeDivide_m(transformInput22_1, transformInput22_2);
        //----------------------------------------------------------
...
//        assertArraySumEqual(originalResult, transformResult6);
        ...
        //OR8:源输出*2等于后续输出
//        assertArraySumDecreasedOrEqual(originalResult, transformResult8);
        //OR9:和应该增加或保持不变
...
//        assertArraySumDecreasedOrEqual(originalResult, transformResult11);
        ...
        //OR13:源输出小于等于等于后续输出
//        assertArraySumDecreasedOrEqual(originalResult, transformResult13);
        //OR14:源输出大于等于等于后续输出
...
//        assertArraySumIncreasedOrEqual(originalResult, transformResult20);
    ...
    public void testCase1() {
        ...
        Double[] originalResult = ebeDivide.ebeDivide_m(originalInput1_1, originalInput1_2);
