import example.manhattanDist;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class manhattanDistTest {
    ...
    private void applyMR_Assert(Integer[] originalInput1_1, Integer[] originalInput1_2, double originalResult) {
        ...
        double transformResult1 = manhattanDist.manhattanDist_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double transformResult2 = manhattanDist.manhattanDist_m(transformInput2_1, transformInput2_2);
        ...
        double transformResult3_1 = manhattanDist.manhattanDist_m(transformInput3_1, transformInput3_2);
        ...
        double transformResult3_2 = manhattanDist.manhattanDist_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = manhattanDist.manhattanDist_m(transformInput4_3, transformInput4_4);
        //MR5:数组缩放变换
        ...
        double transformResult5 = manhattanDist.manhattanDist_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double transformResult6 = manhattanDist.manhattanDist_m(transformInput6_1, transformInput6_2);
        ...
        double transformResult7_1 = manhattanDist.manhattanDist_m(transformInput7_1, transformInput7_2);
        ...
        double transformResult7_2 = manhattanDist.manhattanDist_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double transformResult8 = manhattanDist.manhattanDist_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double transformResult9 = manhattanDist.manhattanDist_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double transformResult10 = manhattanDist.manhattanDist_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double transformResult11 = manhattanDist.manhattanDist_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double transformResult12 = manhattanDist.manhattanDist_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double transformResult13 = manhattanDist.manhattanDist_m(transformInput13_3, transformInput13_4);
        //MR14:移除元素的效果（移除最大值）
...
//        double transformResult14 = manhattanDist.manhattanDist_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double transformResult15 = manhattanDist.manhattanDist_m(transformInput15_3, transformInput15_4);
        ...
        double transformResult16 = manhattanDist.manhattanDist_m(transformInput16_1, transformInput16_2);
        ...
        double transformResult19 = manhattanDist.manhattanDist_m(transformInput19_1, transformInput19_2);
        ...
        double transformResult20 = manhattanDist.manhattanDist_m(transformInput20_3, transformInput20_4);
        //MR22:应用恒等变换
        ...
        double transformResult22 = manhattanDist.manhattanDist_m(transformInput22_1, transformInput22_2);
//        //----------------------------------------------------------
...
//        assertEquals(originalResult, transformResult13, delta);
        //OR14:源输出大于等于后续输出
//        assertEquals(originalResult, transformResult14, delta);
        //OR15:源输出大于等于后续输出
...
//        assertTrue(originalResult == transformResult20);
    ...
    @Test
    public void testManhattanDist1() {
        Integer[] originalInput1_1 = {1, 2, 3, 4, 5};
        Integer[] originalInput1_2 = {5, 4, 3, 2, 1};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testManhattanDist2() {
        Integer[] originalInput1_1 = {10, 20, 30};
        Integer[] originalInput1_2 = {10, 20, 30};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testManhattanDist3() {
        Integer[] originalInput1_1 = {0, 0, 0};
        Integer[] originalInput1_2 = {1, 1, 1};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testManhattanDist4() {
        Integer[] originalInput1_1 = {-1, -2, -3};
        Integer[] originalInput1_2 = {1, 2, 3};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testManhattanDist5() {
    ...
    @Test
    public void testManhattanDist6() {
        Integer[] originalInput1_1 = {1, 1, 1, 1};
        Integer[] originalInput1_2 = {2, 2, 2, 2};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testManhattanDist7() {
        Integer[] originalInput1_1 = {-10, 0, 10};
        Integer[] originalInput1_2 = {10, 0, -10};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testManhattanDist8() {
        Integer[] originalInput1_1 = {100, 200};
        Integer[] originalInput1_2 = {200, 100};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }

    @Test
    public void testManhattanDist9() {
        Integer[] originalInput1_1 = {3, 6, 9};
        Integer[] originalInput1_2 = {1, 2, 3};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    @Test
    public void testManhattanDist10() {
        Integer[] originalInput1_1 = {0, 1, 2, 3, 4};
        Integer[] originalInput1_2 = {4, 3, 2, 1, 0};
        double originalResult = manhattanDist.manhattanDist_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}