...
//        assertTrue(originalResult >= transformResult15);
    ...
    public void testMax_1() {
        ...
        double originalResult = max.max_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }

    @Test
    public void testMax_2() {
        Double[] originalInput = {3.5, 4.2, 5.8, 6.3, 7.7};
        double originalResult = max.max_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    ...
    public void testMax_7() {
        Double[] originalInput = {5.51, -4.42, 3.33, -2.24, 1.15};
        double originalResult = max.max_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
    ...
    public void testMax_10() {
        Double[] originalInput = {1.001, 2.002, 3.003, 4.004, 5.005};
        double originalResult = max.max_m(originalInput);
        applyMR_Assert(originalInput, originalResult);
    }
}