import example.elemtWise_min;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class elemtWise_minTest {
    ...
    private void applyMR_Assert(Integer[] originalInput1_1, Integer[] originalInput1_2, int[] originalResult) {
        ...
        int[] transformResult1 = elemtWise_min.elemtWise_min_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        int[] transformResult2 = elemtWise_min.elemtWise_min_m(transformInput2_1, transformInput2_2);
        ...
        int[] transformResult3_1 = elemtWise_min.elemtWise_min_m(transformInput3_1, transformInput3_2);
        ...
        int[] transformResult3_2 = elemtWise_min.elemtWise_min_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        int[] transformResult4 = elemtWise_min.elemtWise_min_m(transformInput4_3, transformInput4_4);
        //MR5:数组缩放变换
        ...
        int[] transformResult5 = elemtWise_min.elemtWise_min_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        int[] transformResult6 = elemtWise_min.elemtWise_min_m(transformInput6_1, transformInput6_2);
        ...
        int[] transformResult7_1 = elemtWise_min.elemtWise_min_m(transformInput7_1, transformInput7_2);
        ...
        int[] transformResult7_2 = elemtWise_min.elemtWise_min_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        int[] transformResult8 = elemtWise_min.elemtWise_min_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        int[] transformResult9 = elemtWise_min.elemtWise_min_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        int[] transformResult10 = elemtWise_min.elemtWise_min_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        int[] transformResult11 = elemtWise_min.elemtWise_min_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        int[] transformResult12 = elemtWise_min.elemtWise_min_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        int[] transformResult13 = elemtWise_min.elemtWise_min_m(transformInput13_3, transformInput13_4);
        //MR14:移除元素的效果（移除最大值）
        ...
        int[] transformResult14 = elemtWise_min.elemtWise_min_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        int[] transformResult15 = elemtWise_min.elemtWise_min_m(transformInput15_3, transformInput15_4);
        ...
        int[] transformResult16 = elemtWise_min.elemtWise_min_m(transformInput16_1, transformInput16_2);
        ...
        int[] transformResult19 = elemtWise_min.elemtWise_min_m(transformInput19_1, transformInput19_2);
        ...
        int[] transformResult20 = elemtWise_min.elemtWise_min_m(transformInput20_3, transformInput20_4);
        //MR22:应用恒等变换
        ...
        int[] transformResult22 = elemtWise_min.elemtWise_min_m(transformInput22_1, transformInput22_2);
//        //----------------------------------------------------------
...
//        assertArraySumIncreasedOrEqual(originalResult, transformResult19);
    ...
    public void testCase1() {
        ...
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
    ...
    public void testCase2() {
        Integer[] originalInput1_1 = {4, 5, 6, 7};
        Integer[] originalInput1_2 = {4, 5, 6, 8};
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase3() {
        Integer[] originalInput1_1 = {-1, 0, 1};
        Integer[] originalInput1_2 = {-1, 0, 2};
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase4() {
        Integer[] originalInput1_1 = {3, -4, 5, 6};
        Integer[] originalInput1_2 = {3, -4, 5, 7};
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase5() {
        ...
        Integer[] originalInput1_2 = {10, 20, 30, 40, 50};
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase6() {
        Integer[] originalInput1_1 = {5, 4, 3, 2};
        Integer[] originalInput1_2 = {5, 4, 3, 1};
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase7() {
        Integer[] originalInput1_1 = {-7, 8, 9};
        Integer[] originalInput1_2 = {-7, 8, 10};
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase9() {
        Integer[] originalInput1_1 = {1, 2, 3};
        Integer[] originalInput1_2 = {0, 2, 3};
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase10() {
        Integer[] originalInput1_1 = {0, 0, 0, 1};
        Integer[] originalInput1_2 = {0, 0, 0, 1};
        int[] originalResult = elemtWise_min.elemtWise_min_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}