...
//        assertTrue(originalResult <= transformResult16);
    ...
    public void testLag1() {
        ...
        Double mean = 3.0;
        double originalResult = lag.lag_m(originalInput, mean);
    ...
    public void testLag3() {
        Double[] originalInput = {1.5, 2.5, 3.5, 4.5};
        Double mean = 2.5;
        double originalResult = lag.lag_m(originalInput, mean);
        applyMR_Assert(originalInput, mean, originalResult);
    }
    ...
    @Test
    public void testLag5() {
        Double[] originalInput = {-10.0, 0.0, 10.0, 20.0};
        Double mean = 5.0;
        double originalResult = lag.lag_m(originalInput, mean);
        applyMR_Assert(originalInput, mean, originalResult);
    }
    ...
    @Test
    public void testLag6() {
        Double[] originalInput = {1.0, 2.5, 3.5, 1.5, 2.0};
        Double mean = 2.0;
        double originalResult = lag.lag_m(originalInput, mean);
        applyMR_Assert(originalInput, mean, originalResult);
    }
    ...
    @Test
    public void testLag7() {
        Double[] originalInput = {5.0, 6.2, 3.0, 4.5};
        Double mean = 3.0;
        double originalResult = lag.lag_m(originalInput, mean);
        applyMR_Assert(originalInput, mean, originalResult);
    }
    ...
    @Test
    public void testLag10() {
        Double[] originalInput = {3.14, 2.71, 1.61, 0.57};
        Double mean = 1.5;
        double originalResult = lag.lag_m(originalInput, mean);
        applyMR_Assert(originalInput, mean, originalResult);
    }
