...
public class set_min_valTest {
    ...
    private void applyMR_Assert(Integer[] originalInput, Integer k, Integer[] originalResult) {
        ...
        Integer[] transformResult1 = set_min_val.set_min_val_m(transformInput1, k);
        //MR2:数组元素常数加法
        Integer[] transformInput2 = MetamorphicTestGenerator1.applyMR2(originalInput);
        Integer[] transformResult2 = set_min_val.set_min_val_m(transformInput2, k);
        //MR3_1:加入单位元不变性（加法的单位元0）
        Integer[] transformInput3_1 = MetamorphicTestGenerator1.applyMR3_1(originalInput);
        Integer[] transformResult3_1 = set_min_val.set_min_val_m(transformInput3_1, k);
        //MR3_2:加入单位元不变性（乘法的单位元1）
        Integer[] transformInput3_2 = MetamorphicTestGenerator1.applyMR3_2(originalInput);
        Integer[] transformResult3_2 = set_min_val.set_min_val_m(transformInput3_2, k);
        //MR4:数组元素取倒数
        ...
        Integer[] transformResult13 = set_min_val.set_min_val_m(transformInput13_1, k);
        //MR14:移除元素的效果（移除最大值）
        Integer[] transformInput14 = MetamorphicTestGenerator1.applyMR14(originalInput);
        Integer[] transformResult14 = set_min_val.set_min_val_m(transformInput14, k);
        //MR15:类三角函数的周期性
//        Integer[] transformInput15 = MetamorphicTestGenerator1.applyMR15(originalInput);
//        Integer[] transformResult15 = set_min_val.set_min_val_m(transformInput15, k);
        //MR16:重复值稳健性(复制输入中的一个元素)
        Integer[] transformInput16 = MetamorphicTestGenerator1.applyMR16(originalInput);
        Integer[] transformResult16 = set_min_val.set_min_val_m(transformInput16, k);
        //MR19:输入重复（元素复制）将元素a重复多次插入序列中
        Integer[] transformInput19 = MetamorphicTestGenerator1.applyMR19(originalInput, 2);
        Integer[] transformResult19 = set_min_val.set_min_val_m(transformInput19, k);
        ...
        Integer[] transformResult20 = set_min_val.set_min_val_m(transformInput20_1, k);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        Integer[] transformResult22 = set_min_val.set_min_val_m(transformInput22, k);
        //----------------------------------------------------------
...
//        assertArraySumEqual(originalResult, transformResult20);
        //OR22:源输出等于后续输出
    ...
    @Test
    public void testSetMinValCase1() {
        Integer[] originalInput = {1, 3, 5, 7, 9};
        Integer k = 5;
        Integer[] originalResult = set_min_val.set_min_val_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }

    @Test
    public void testSetMinValCase2() {
    ...
    @Test
    public void testSetMinValCase3() {
    ...
    @Test
    public void testSetMinValCase4() {
        Integer[] originalInput = {7, 8, 9, 10};
        Integer k = 6;
        Integer[] originalResult = set_min_val.set_min_val_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }
    ...
    @Test
    public void testSetMinValCase5() {
        Integer[] originalInput = {5, 7, 5, 7, 5};
        Integer k = 7;
        Integer[] originalResult = set_min_val.set_min_val_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }
    ...
    @Test
    public void testSetMinValCase6() {
        Integer[] originalInput = {100, 200, 300, 400};
        Integer k = 200;
        Integer[] originalResult = set_min_val.set_min_val_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }
    ...
    @Test
    public void testSetMinValCase7() {
        Integer[] originalInput = {-16, 28, -38, 40};
        Integer k = -25;
        Integer[] originalResult = set_min_val.set_min_val_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }
    ...
    @Test
    public void testSetMinValCase8() {
        Integer[] originalInput = {1, 1, 1, 1, 1};
        Integer k = 1;
        Integer[] originalResult = set_min_val.set_min_val_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }
    ...
    @Test
    public void testSetMinValCase9() {
        Integer[] originalInput = {0, 2, 4, 6, 8};
        Integer k = 8;
        Integer[] originalResult = set_min_val.set_min_val_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }
    ...
    @Test
    public void testSetMinValCase10() {
