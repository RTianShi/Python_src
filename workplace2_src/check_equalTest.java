...
public class check_equalTest {
    ...
    private void applyMR_Assert(Integer[] originalInput1_1, Integer[] originalInput1_2, boolean originalResult) {
        ...
        boolean transformResult1 = check_equal.check_equal_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        boolean transformResult2 = check_equal.check_equal_m(transformInput2_1, transformInput2_2);
        ...
        boolean transformResult3_1 = check_equal.check_equal_m(transformInput3_1, transformInput3_2);
        ...
        boolean transformResult3_2 = check_equal.check_equal_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        boolean transformResult4 = check_equal.check_equal_m(transformInput4_3, transformInput4_4);
        //MR5:数组缩放变换
        ...
        boolean transformResult5 = check_equal.check_equal_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        boolean transformResult6 = check_equal.check_equal_m(transformInput6_1, transformInput6_2);
        ...
        boolean transformResult7_1 = check_equal.check_equal_m(transformInput7_1, transformInput7_2);
        ...
        boolean transformResult7_2 = check_equal.check_equal_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        boolean transformResult8 = check_equal.check_equal_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        boolean transformResult9 = check_equal.check_equal_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        boolean transformResult10 = check_equal.check_equal_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        boolean transformResult11 = check_equal.check_equal_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        boolean transformResult12 = check_equal.check_equal_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        boolean transformResult13 = check_equal.check_equal_m(transformInput13_3, transformInput13_4);
        //MR14:移除元素的效果（移除最大值）
        ...
        boolean transformResult14 = check_equal.check_equal_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        boolean transformResult15 = check_equal.check_equal_m(transformInput15_3, transformInput15_4);
        ...
        boolean transformResult16 = check_equal.check_equal_m(transformInput16_1, transformInput16_2);
        ...
        boolean transformResult19 = check_equal.check_equal_m(transformInput19_1, transformInput19_2);
        ...
        boolean transformResult20 = check_equal.check_equal_m(transformInput20_3, transformInput20_4);
        //MR22:应用恒等变换
        ...
        boolean transformResult22 = check_equal.check_equal_m(transformInput22_1, transformInput22_2);
//        //----------------------------------------------------------
...
//        assertTrue(Arrays.equals(formatArray(originalResult, 2), formatArray(transformResult1, 2)));
    ...
    public void testCase1() {
        ...
        boolean originalResult = check_equal.check_equal_m(originalInput1_1, originalInput1_2);
