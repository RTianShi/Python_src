import example.get_array_value;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class get_array_valueTest {

    private void applyMR_Assert(Integer[] originalInput, Integer k, int originalResult) {
        //MR1:数组元置换（打乱顺序）
        Integer[] transformInput1 = MetamorphicTestGenerator1.applyMR1(originalInput);
        int transformResult1 = get_array_value.get_array_value_m(transformInput1, k);
        //MR2:数组元素常数加法
        Integer[] transformInput2 = MetamorphicTestGenerator1.applyMR2(originalInput);
        int transformResult2 = get_array_value.get_array_value_m(transformInput2, k);
        //MR3_1:加入单位元不变性（加法的单位元0）
        Integer[] transformInput3_1 = MetamorphicTestGenerator1.applyMR3_1(originalInput);
        int transformResult3_1 = get_array_value.get_array_value_m(transformInput3_1, k);
        //MR3_2:加入单位元不变性（乘法的单位元1）
        Integer[] transformInput3_2 = MetamorphicTestGenerator1.applyMR3_2(originalInput);
        int transformResult3_2 = get_array_value.get_array_value_m(transformInput3_2, k);
        //MR4:数组元素取倒数
        ...
        int transformResult4 = get_array_value.get_array_value_m(transformInput4_1, k);
        //MR5:数组缩放变换
        Integer[] transformInput5 = MetamorphicTestGenerator1.applyMR5(originalInput, 2);
        int transformResult5 = get_array_value.get_array_value_m(transformInput5, k);
        //MR6:数组反转变换
        Integer[] transformInput6 = MetamorphicTestGenerator1.applyMR6(originalInput);
        int transformResult6 = get_array_value.get_array_value_m(transformInput6, k);
        //MR7_1:中立操作的恒等变换（所有元素乘以1）
        Integer[] transformInput7_1 = MetamorphicTestGenerator1.applyMR7_1(originalInput);
        int transformResult7_1 = get_array_value.get_array_value_m(transformInput7_1, k);
        //MR7_2:中立操作的恒等变换（所有元素加上0）
        Integer[] transformInput7_2 = MetamorphicTestGenerator1.applyMR7_2(originalInput);
        int transformResult7_2 = get_array_value.get_array_value_m(transformInput7_2, k);
        //MR8:重复输入数组
        Integer[] transformInput8 = MetamorphicTestGenerator1.applyMR8(originalInput);
        int transformResult8 = get_array_value.get_array_value_m(transformInput8, k);
        //MR9:复合转换一致性
        Integer[] transformInput9 = MetamorphicTestGenerator1.applyMR9(originalInput, 3);
        int transformResult9 = get_array_value.get_array_value_m(transformInput9, k);
        //MR10:单调性检验
        Integer[] transformInput10 = MetamorphicTestGenerator1.applyMR10(originalInput);
        int transformResult10 = get_array_value.get_array_value_m(transformInput10, k);
        //MR11:边界值替换(把最大值替换成0)
        Integer[] transformInput11 = MetamorphicTestGenerator1.applyMR11(originalInput);
        int transformResult11 = get_array_value.get_array_value_m(transformInput11, k);
        //MR12:数值取反变换
        Integer[] transformInput12 = MetamorphicTestGenerator1.applyMR12(originalInput);
        int transformResult12 = get_array_value.get_array_value_m(transformInput12, k);
        //MR13:微小增量调整
        ...
        double transformResult13 = get_array_value.get_array_value_m(transformInput13_1, k);
        //MR14:移除元素的效果（移除最大值）
//        Integer[] transformInput14 = MetamorphicTestGenerator1.applyMR14(originalInput);
//        int transformResult14 = get_array_value.get_array_value_m(transformInput14);
        //MR15:类三角函数的周期性
//        Integer[] transformInput15 = MetamorphicTestGenerator1.applyMR15(originalInput);
//        int transformResult15 =    get_array_value.   get_array_value_m(transformInput15);
        //MR16:重复值稳健性(复制输入中的一个元素)
        Integer[] transformInput16 = MetamorphicTestGenerator1.applyMR16(originalInput);
        int transformResult16 = get_array_value.get_array_value_m(transformInput16, k);
        //MR19:输入重复（元素复制）将元素a重复多次插入序列中
        Integer[] transformInput19 = MetamorphicTestGenerator1.applyMR19(originalInput, 2);
        int transformResult19 = get_array_value.get_array_value_m(transformInput19, k);
        ...
        double transformResult20 = get_array_value.get_array_value_m(transformInput20_1, k);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        int transformResult22 = get_array_value.get_array_value_m(transformInput22, k);
        //----------------------------------------------------------
//        //OR1:和应该保持不变
...
//        assertTrue(originalResult >= transformResult15);
    ...
    public void testCase1() {
        ...
        Integer k = 2;
        int originalResult = get_array_value.get_array_value_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }

    @Test
    public void testCase2() {
        Integer[] originalInput = {1, 0, 1, 0, 1};
        Integer k = 3;
        int originalResult = get_array_value.get_array_value_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }
    ...
    public void testCase10() {
        Integer[] originalInput = {11, 10, 11, 12, 10};
        Integer k = 1;
        int originalResult = get_array_value.get_array_value_m(originalInput, k);
        applyMR_Assert(originalInput, k, originalResult);
    }
