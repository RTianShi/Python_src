import example.count_k;
import org.junit.Test;

import static org.junit.Assert.assertTrue;

public class count_kTest {
...
//        int transformResult19 = count_k.count_k_m(transformInput19);
        ...
        double transformResult20 = count_k.count_k_m(transformInput20_1, k);
        //MR22:应用恒等变换
        Integer[] transformInput22 = MetamorphicTestGenerator1.applyMR22(originalInput);
        int transformResult22 = count_k.count_k_m(transformInput22, k);
        //----------------------------------------------------------
//        //OR1:和应该保持不变
...
//        assertTrue(originalResult >= transformResult15);
    ...
    public void testCase1() {
        Integer[] originalInput = {1, 2, 3, 4, 2};
        Integer k = 2;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }

    @Test
    public void testCase2() {
        Integer[] originalInput = {20, -20, 0, -20, 20};
        Integer k = 0;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }
    ...
    public void testCase3() {
        Integer[] originalInput = {-1, 0, 1, -1, 0};
        Integer k = 0;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }
    ...
    public void testCase4() {
        Integer[] originalInput = {36, -36, 36, -36};
        Integer k = 0;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }
    ...
    public void testCase5() {
        Integer[] originalInput = {20, -20, 20, -20, 20};
        Integer k = 0;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }
    ...
    public void testCase6() {
        Integer[] originalInput = {-35, -35, 35, 35, 35};
        Integer k = 0;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }
    ...
    public void testCase7() {
        Integer[] originalInput = {3000, 2000, 1000, 0};
        Integer k = 1;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }
    ...
    public void testCase8() {
        Integer[] originalInput = {0, 0, -1, 1, -1};
        Integer k = 0;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }
    ...
    public void testCase9() {
        Integer[] originalInput = {2, -2, 2, -2, -2};
        Integer k = 2;
        int originalResult = count_k.count_k_m(originalInput, k);
        applyMR_Assert(originalInput, originalResult, k);
    }
