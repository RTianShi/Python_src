...
public class covarianceTest {
    ...
    private void applyMR_Assert(Double[] originalInput1_1, Double[] originalInput1_2, double originalResult) {
        ...
        double transformResult1 = covariance.covariance_m(transformInput1_1, transformInput1_2);
        //MR2:数组元素常数加法
        ...
        double transformResult2 = covariance.covariance_m(transformInput2_1, transformInput2_2);
        ...
        double transformResult3_1 = covariance.covariance_m(transformInput3_1, transformInput3_2);
        ...
        double transformResult3_2 = covariance.covariance_m(transformInput3_3, transformInput3_4);
        //MR4:数组元素取倒数
        ...
        double transformResult4 = covariance.covariance_m(transformInput4_1, transformInput4_2);
        //MR5:数组缩放变换
        ...
        double transformResult5 = covariance.covariance_m(transformInput5_1, transformInput5_2);
        //MR6:数组反转变换
        ...
        double transformResult6 = covariance.covariance_m(transformInput6_1, transformInput6_2);
        ...
        double transformResult7_1 = covariance.covariance_m(transformInput7_1, transformInput7_2);
        ...
        double transformResult7_2 = covariance.covariance_m(transformInput7_3, transformInput7_4);
        //MR8:重复输入数组
        ...
        double transformResult8 = covariance.covariance_m(transformInput8_1, transformInput8_2);
        //MR9:复合转换一致性
        ...
        double transformResult9 = covariance.covariance_m(transformInput9_1, transformInput9_2);
        //MR10:单调性检验
        ...
        double transformResult10 = covariance.covariance_m(transformInput10_1, transformInput10_2);
        //MR11:边界值替换(把最大值替换成0)
        ...
        double transformResult11 = covariance.covariance_m(transformInput11_1, transformInput11_2);
        //MR12:数值取反变换
        ...
        double transformResult12 = covariance.covariance_m(transformInput12_1, transformInput12_2);
        //MR13:微小增量调整
        ...
        double transformResult13 = covariance.covariance_m(transformInput13_1, transformInput13_2);
        //MR14:移除元素的效果（移除最大值）
        ...
        double transformResult14 = covariance.covariance_m(transformInput14_1, transformInput14_2);
        //MR15:类三角函数的周期性
        ...
        double transformResult15 = covariance.covariance_m(transformInput15_1, transformInput15_2);
        ...
        double transformResult16 = covariance.covariance_m(transformInput16_1, transformInput16_2);
        ...
        double transformResult19 = covariance.covariance_m(transformInput19_1, transformInput19_2);
        ...
        double transformResult20 = covariance.covariance_m(transformInput20_1, transformInput20_2);
        //MR22:应用恒等变换
        ...
        double transformResult22 = covariance.covariance_m(transformInput22_1, transformInput22_2);
        //----------------------------------------------------------
...
//        assertTrue(originalResult >= transformResult20);
    ...
    public void testCase1() {
        Double[] originalInput1_1 = {1.5, 2.5, 3.5, 4.5};
        Double[] originalInput1_2 = {2.0, 3.0, 4.0, 5.0};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
    ...
    public void testCase2() {
        Double[] originalInput1_1 = {1.25, 0.05, 1.35, 2.25};
        Double[] originalInput1_2 = {0.55, 0.55, 1.05, 1.55};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase3() {
        Double[] originalInput1_1 = {3.3, -2.2, 4.4, -3.3};
        Double[] originalInput1_2 = {1.1, -1.2, 2.2, -2.1};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase4() {
        Double[] originalInput1_1 = {5.5, 6.6, 7.7, 8.8};
        Double[] originalInput1_2 = {1.0, 1.5, 2.0, 2.5};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase5() {
        Double[] originalInput1_1 = {0.05, 1.5, 2.5, 3.0};
        Double[] originalInput1_2 = {4.0, 3.0, 2.0, 1.0};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase6() {
        Double[] originalInput1_1 = {-2.2, -1.1, 0.0, 1.1};
        Double[] originalInput1_2 = {2.2, 1.1, 0.0, -1.1};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase7() {
        Double[] originalInput1_1 = {-3.5, 2.5, -1.0, 0.5};
        Double[] originalInput1_2 = {2.0, -1.5, 0.5, 1.0};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase8() {
        ...
        Double[] originalInput1_2 = {-1.0, 2.0, 3.0, -4.0};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase9() {
        ...
        Double[] originalInput1_2 = {2.05, 1.05, 0.05, 1.05};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
    ...
    public void testCase10() {
        Double[] originalInput1_1 = {4.4, 5.5, 6.6, -7.7};
        Double[] originalInput1_2 = {-2.2, -3.3, -4.4, 5.5};
        double originalResult = covariance.covariance_m(originalInput1_1, originalInput1_2);
        applyMR_Assert(originalInput1_1, originalInput1_2, originalResult);
    }
}